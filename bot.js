...
//This is the controller for the slack instance of the bot
...
// Set up an Express-powered webserver to expose oauth and webhook endpoints for the slack instance
...
// Open the web socket server supporting the instance of the bot that interacts with the Pepper robot
...
console.log('The webserver exposing webhook endpoints for interaction with the Pepper robot are exposed at port 3000');
...
if (!process.env.clientId || !process.env.clientSecret) {
  ...
  console.log('The webserver exposing webhook endpoints for interaction with the slack are exposed at port 3001');
